   ...
   implements SurfaceHolder.Callback
{
   ...
   public void newGame()
   {
      ...
      blockerVelocity = initialBlockerVelocity + (LEVEL*10); // set initial velocity
      targetVelocity = initialTargetVelocity + (LEVEL*10); // set initial velocity
   ...
   public void drawGameElements(Canvas canvas)
   {
      ...
      canvas.drawText(getResources().getString(
    	         R.string.highest_Points, highestPoints), 30, 90, textPaint);
      ...
      final DialogFragment gameResult = 
         new DialogFragment()
         {
            ...
            public Dialog onCreateDialog(Bundle bundle)
            {
               ...
               String last_msg =  getString(messageId);
               
               if(last_msg.equalsIgnoreCase("You win!") && LEVEL <= 9){
            	   
            	   
                   
            	// display number of shots fired and total time elapsed
                   builder.setMessage(getResources().getString(
                      R.string.results_format, shotsFired, totalElapsedTime,point));
